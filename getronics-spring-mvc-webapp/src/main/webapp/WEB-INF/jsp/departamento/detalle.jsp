			...
			<tbody>
				<c:forEach items="${ departamento.tecnologias }" var="tecnologia">
					<tr>
						...
						<td>
							<a class="mr-1" href="<spring:url value="/departamento/deleteTecnologia/${ tecnologia.getId() }"></spring:url>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
