...
<table>
	<thead>
		...
		<th><spring:message code="empleado.departamento"></spring:message></th>
	...
	<tbody>
		...
		<c:forEach items="${ empleados }" var="alumno">
			<tr>
				...
				<td><a
					href="<spring:url value="/empleado/delete/${ alumno.id }" ></spring:url>">Eliminar</a>
					<a
					href="<spring:url value="/empleado/update/${ alumno.id }" ></spring:url>">Actualizar</a>
				</td>
			</tr>
		</c:forEach>
