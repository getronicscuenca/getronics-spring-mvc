...
<div class="table-responsive">
	<table class="table table-striped table-info">
		<thead class="thead-light">
			...
			<th scope="col"><spring:message code="tecnologia.desc"></spring:message></th>
			<th scope="col"><spring:message code="tecnologia.departamentos"></spring:message></th>
		...
		<tbody>
			...
			<c:forEach items="${ tecnologias }" var="tecnologia">
				<tr>
					...
					<td>${tecnologia.desc}</td>
															
					<c:forEach items="${ tecnologia.departamentos }" var="departamento">
...
<form:form action="${ url }" cssClass="row justify-content-end mr-5">
	...
	<a href="<spring:url value="/index.jsp"></spring:url>">volver</a> 
