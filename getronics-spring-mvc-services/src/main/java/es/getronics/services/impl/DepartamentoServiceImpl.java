...
public class DepartamentoServiceImpl implements DepartamentoService {
	...
	public DepartamentoDto insert(DepartamentoDto dto) {
		...
		if(departamentoExiste) {
			throw new GetronicsDaoException("El departamento ya existe");
		}
		else  
			/*if(dto.getJefe()==null) {
				...
				if (dto.getSelectedTecnologias()==null){
					throw new GetronicsDaoException("El departamento tiene que tener al menos una tecnologia");
				}
				else {
	...
	public void remove(Long id) {
		...
		throw new GetronicsDaoException("No se puede eliminar el departamento porque tiene empleados");
		}
		else {
